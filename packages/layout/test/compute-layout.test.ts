    ...
    const reader = fixtureReader([
      {
        ...
        children: ['a', 'b'],
        autoLayout: { mode: 'HORIZONTAL', gap: 10, paddingLeft: 5, paddingRight: 5, paddingTop: 5, paddingBottom: 5 },
      },
    ...
    const reader = fixtureReader([
      {
        ...
        layoutSizingVertical: 'HUG',
        children: ['inner'],
        autoLayout: { mode: 'HORIZONTAL', paddingLeft: 10, paddingRight: 10, paddingTop: 10, paddingBottom: 10 },
      },
      {
        id: 'inner',
        type: 'FRAME',
        ...
        layoutSizingVertical: 'HUG',
        children: ['leaf'],
        autoLayout: { mode: 'VERTICAL', paddingLeft: 5, paddingRight: 5, paddingTop: 5, paddingBottom: 5 },
      },
