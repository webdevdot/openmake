...
import '../config.js'; // loads the repo-root .env as a side effect
...
/** Applies all migrations to the test database via the Prisma CLI, from the database package's directory. */
function applyMigrations(): void {
  const databasePackageRoot = path.resolve(import.meta.dirname, '../../../../packages/database');
