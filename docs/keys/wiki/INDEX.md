# openmake — Project Wiki

> Knowledge base for the openmake design platform (org: webdevdot).

## Pages

- [architecture.md](architecture.md) — as-built system shape, hot-path rules, sync persistence, self-host
